...
LOST_LINE_MAX   = 15    # nb de frames sans ligne avant arret complet
lost_line_count = 0

# Balayage de la tete pour rechercher la ligne
HEAD_CHANNEL = 0
HEAD_CENTRE  = 105
HEAD_GAUCHE  = 140
HEAD_DROITE  = 60
HEAD_STEP    = 8         # increment angle par frame de recherche

head_angle     = HEAD_CENTRE
head_direction = 0 
...
def start_move():
    ...
    global prev_error, last_steering, lost_line_count
    global head_angle, head_direction
    ...
    head_angle = HEAD_CENTRE
    head_direction = 1
    set_angle(HEAD_CHANNEL, HEAD_CENTRE)
        ...
        while True:
            ...
            if state == RUNNING:
                ...
                if M['m00'] > 0:
                    ...
                    lost_line_count += 1
                    cv2.putText(frame, "LIGNE PERDUE", (10, 30),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)

            if lost_line_count >= LOST_LINE_MAX:
                stop_robot(reason="ligne perdue")
            else:
